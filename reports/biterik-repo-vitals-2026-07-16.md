...
_Updated 2026-07-16T05:56:23Z (UTC) · machine-readable: [VITALS.json](VITALS.json) · full history: [history.ndjson](history.ndjson) · daily snapshots: [snapshots/](snapshots/)_
...
**Health: 37/100** (heuristic² — traffic trend 23, activity 84, community 8, release adoption 10)
...
**Conversion funnel (30 d):** 4 unique visitors → 121 unique cloners → 0 stars gained → 0 downloads gained
...
|---|---:|---:|
| github.com | 12 | 1 |
| biterik.github.io | 4 | 1 |

| Popular path | Views | Unique |
|---|---:|---:|
| `/biterik/repo-vitals` | 10 | 1 |
| `/biterik/repo-vitals/actions` | 2 | 1 |
| `/biterik/repo-vitals/blob/main/CITATION.cff` | 2 | 1 |
| `/biterik/repo-vitals/actions/runs/28921501650` | 1 | 1 |
...
21 commits · 0 PRs opened / 0 merged · 0 issues opened / 0 closed · 1 contributors total
...
[reports/biterik-repo-vitals-2026-07-16.md](reports/biterik-repo-vitals-2026-07-16.md)
